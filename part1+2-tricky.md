...
2. **Сопротивление изменений**: Тесей, хотя и признаёт необходимость адаптации, пытается сохранить устаревшую систему, основанную на страхе и подавлении, что вызывает сопротивление как у изгоев, так и у части горожан.
